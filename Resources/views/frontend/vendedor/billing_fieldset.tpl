<div class="panel register--company is--hidden">
    {block name='frontend_register_billing_fieldset_company_panel'}
        {block name='frontend_register_billing_fieldset_company_title'}
            <h2 class="panel--title is--underline">
                {s name='ShopName' force}Nombre de la tienda{/s}
            </h2>
        {/block}

        {block name='frontend_register_billing_fieldset_company_body'}
                ...
                {block name='frontend_register_billing_fieldset_input_company'}
                    <div class="register--companyname">
                        <input autocomplete="section-billing billing organization"
                               ...
                               required="required"
                               aria-required="true"
                               placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterPlaceholderCompany' force}Nombre de la tienda{/s}"
...
<div class="panel register--address">
    {block name='frontend_register_billing_fieldset_panel'}
        {block name='frontend_register_billing_fieldset_title'}
            <h2 class="panel--title is--underline">
                {s name='RegisterBillingHeadline' force}Dirección de la tienda o contacto{/s}
            </h2>
        {/block}
                ...
                {block name='frontend_register_billing_fieldset_input_street'}
                    <div class="register--street">
                        <input autocomplete="section-billing billing street-address"
                               ...
                               required="required"
                               aria-required="true"
                               placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterBillingPlaceholderStreet' force}Calle y número{/s}"
                               id="street"
                    ...
                    {if {config name=showAdditionAddressLine1}}
                        <div class="register--additional-line1">
                            <input autocomplete="section-billing billing address-line2"
                                   ...
                                   placeholder="{if {config name=requireAdditionAddressLine1}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}{s name='RegisterLabelAdditionalAddressLine1' force}campo adicional{/s}"
                    ...
                    <div class="register--zip-city">
                        {if {config name=showZipBeforeCity}}
                            <input autocomplete="section-billing billing postal-code"
                                   ...
                                   required="required"
                                   aria-required="true"
                                   placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterBillingPlaceholderZipcode' force}Código postal{/s}"
                                   id="zipcode"
                            ...
                            <input autocomplete="section-billing billing address-level2"
                                   ...
                                   required="required"
                                   aria-required="true"
                                   placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterBillingPlaceholderCity' force}Ciudad{/s}"
                                   id="city"
                    ...
                    <div class="register--country field--select select-field">
                        <select name="register[billing][country]"
                            ...
                            <option disabled="disabled"
                                    value=""
                                    selected="selected">
                                {s name='RegisterBillingPlaceholderCountry' force}País{/s}
                                {s name="RequiredField" namespace="frontend/register/index" force}*{/s}
                            </option>
