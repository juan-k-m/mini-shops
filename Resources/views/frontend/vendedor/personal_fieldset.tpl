<div class="panel register--personal">
    ...
    {block name='frontend_register_personal_fieldset_panel'}
        {block name='frontend_register_personal_fieldset_title'}
            <h1 class="panel--title is--underline">
          {s name="registroVendedoresTitle"}Registro de vendedores{/s}
        </h1>
        {/block}

        {block name='frontend_register_personal_fieldset_body'}
                ...
                {block name='frontend_register_personal_fieldset_input_firstname'}
                    <div class="register--firstname">
                        <input autocomplete="section-personal given-name"
                               ...
                               required="required"
                               aria-required="true"
                               placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterPlaceholderFirstname' force}Nombre(s){/s}"
                               id="firstname"
                ...
                {block name='frontend_register_personal_fieldset_input_lastname'}
                    <div class="register--lastname">
                        <input autocomplete="section-personal family-name"
                               ...
                               required="required"
                               aria-required="true"
                               placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterPlaceholderLastname' force}Apellido(s){/s}"
                    ...
                    {block name='frontend_register_personal_fieldset_input_mail'}
                        <div class="register--email">
                            <input autocomplete="section-personal email"
                                   ...
                                   required="required"
                                   aria-required="true"
                                   placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterPlaceholderMail' force}Correo electrónico{/s}"
                    ...
                    <div class="register--account-information">
                        ...
                        {block name='frontend_register_personal_fieldset_input_password'}
                            <div class="register--password">
                                <input name="register[personal][password]"
                                       ...
                                       required="required"
                                       aria-required="true"
                                       placeholder="{s name="RequiredField" namespace="frontend/register/index"}{/s}{s name='RegisterPlaceholderPassword'}Contrasena{/s}"
                        ...
                        {block name='frontend_register_personal_fieldset_password_description'}
                            <div class="register--password-description">
                                {s name='RegisterInfoPassword' force}La contrasena debe de contener minimamente {/s} {config name=MinPassword} {s name='RegisterInfoPasswordCharacters' force}caracteres.{/s}<br />{s name='RegisterInfoPassword2'}{/s}
                            </div>
                        {/block}
                    </div>
                {/if}
                    ...
                    {if {config name=showPhoneNumberField}}
                        <div class="register--phone">
                            <input autocomplete="section-personal tel"
                                   ...
                                   type="tel" required="required" aria-required="true"
                                   placeholder="{s name='RegisterPlaceholderPhone' force}Teléfono{/s}{if {config name=requirePhoneField}}{s name="RequiredField" namespace="frontend/register/index"}{/s}{/if}"
                                   id="phone"
